...
GLOBAL OPTIONS:
   ...
   --fallback value, -f value          Bootstrap DNS for DoH and DoT, can be specified multiple times (default: "tls://dns.rubyfish.cn", "https://dns.rubyfish.cn/dns-query", "https://i.233py.com/dns-query")
